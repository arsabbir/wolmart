...
import doctor_thumb_01 from "../../assets/img//doctors/doctor-thumb-01.jpg";
...
const Header = () => {
  ...
  // const { auth, error, message } = useSelector((state) => state.auth);
        ...
        <ul className="nav user-menu">
          ...
          <li className="nav-item dropdown has-arrow">
              ...
              <span className="user-img">
                <img
                  ...
                  src={
                    user?.photo
                      ? user?.photo
                      : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuSoxjAIC6TeoVH2K0Gm11V9gDYpthnDcAyw&usqp=CAU"
                  }
                  width="31"
                  alt="Ryan Taylor"
                />
            ...
            <div className="dropdown-menu">
              ...
              <a onClick={handleLogoutUser} className="dropdown-item" href="#">
                Logout
              </a>
            </div>
          </li>
